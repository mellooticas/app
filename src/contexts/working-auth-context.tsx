...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const redirectUserBasedOnType = (): void => {
    if (userProfile) {
      redirectByVote(userProfile, true);
    } else {
      console.warn('Nenhum perfil disponível para redirecionamento');
    }
  }; 
