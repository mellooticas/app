...
export const ROUTES = {
    ...
    PROFESSOR: {
        ...
        CLASS_DETAIL: (id) => `/professores/turmas/${id}`,
        // Submissões
        SUBMISSIONS: '/professores/submissoes',
        SUBMISSION_DETAIL: (id) => `/professores/submissoes/${id}`,
        // Outros
    ...
    ADMIN: {
        ...
        USER_EDIT: (id) => `/admin/usuarios/${id}`,
        // Gestão
    ...
    HISTORIA: {
        ...
        PERIODO_DETAIL: (id) => `/historia/periodos/${id}`,
        COMPOSITORES: '/historia/compositores',
        COMPOSITOR_DETAIL: (id) => `/historia/compositores/${id}`,
        OBRAS: '/historia/obras',
        OBRA_DETAIL: (id) => `/historia/obras/${id}`,
...
// HELPERS
// ========================================
export const getDashboardRoute = (tipoUsuario) => {
    const map = {
