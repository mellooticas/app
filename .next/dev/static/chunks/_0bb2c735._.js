...
"[project]/lib/supabase/admin-client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const supabaseUrl = ("TURBOPACK compile-time value", "https://eehidnwlwrzqzgytbfsd.supabase.co");
const supabaseServiceRoleKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVlaGlkbndsd3J6cXpneXRiZnNkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0ODIzMDUyNCwiZXhwIjoyMDYzODA2NTI0fQ.mMC73MQr1pl4vEWvAVQHxUfA_G06bp9Vx34Ocnv-MVY");
if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
;
const adminSupabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$esm$2f$wrapper$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])(supabaseUrl, supabaseServiceRoleKey, {
    auth: {
...
"[project]/lib/supabase/queries/admin.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/admin-client.ts [app-client] (ecmascript)");
;
async function getAdminDashboardStats() {
    ...
    try {
        ...
        const alunosResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*', {
            count: 'exact',
            head: true
        ...
        const professoresResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*', {
            count: 'exact',
            head: true
        ...
        const aulasResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('aulas').select('*', {
            count: 'exact',
            head: true
        });
        ...
        const aulasHojeResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('aulas').select('*', {
            count: 'exact',
            head: true
...
async function getProfessores(filters) {
    try {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*', {
            count: 'exact'
        }).eq('tipo_usuario', 'professor');
        if (filters?.search) {
...
async function getProfessorById(userId) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*').eq('id', userId).eq('tipo_usuario', 'professor').single();
        if (error) throw error;
        return data;
    } catch (error) {
...
async function getAlunoById(userId) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*').eq('id', userId).eq('tipo_usuario', 'aluno').single();
        if (error) throw error;
        return data;
    } catch (error) {
...
async function getAulasAgendadas(limit = 10) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminSupabase"].from('aulas').select('*').order('data_programada', {
            ascending: true
        }).limit(limit);
        if (error) throw error;
        return data || [];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/queries/admin.ts [app-client] (ecmascript)");
;
...
function AdminDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            async function loadStats() {
                ...
                try {
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdminDashboardStats"])();
    ...
    const statsCards = [
        ...
        },
        {
            ...
            value: loading ? '...' : stats.totalProfessores.toString(),
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$users$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Users$3e$__["Users"],
            color: 'bg-green-500'
        },
        {
            name: 'Aulas Hoje',
            value: loading ? '...' : stats.aulasHoje.toString(),
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$calendar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Calendar$3e$__["Calendar"],
            color: 'bg-purple-500'
        },
        {
            name: 'Total de Aulas',
            value: loading ? '...' : stats.totalAulas.toString(),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Visão geral do sistema Nipo School"
                    }, void 0, false, {
                        fileName: "[project]/app/(protected)/admin/page.tsx",
                        lineNumber: 53,
                        columnNumber: 9
            ...
            error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Verifique o console do navegador (F12) para mais detalhes"
                    }, void 0, false, {
                        fileName: "[project]/app/(protected)/admin/page.tsx",
                        lineNumber: 60,
                        columnNumber: 11
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: "Prof. Tanaka"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(protected)/admin/page.tsx",
                                                lineNumber: 109,
                                                columnNumber: 15
                                            }, this),
                                            " registrou presença em",
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "font-semibold",
                                                children: " Shamisen Básico"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(protected)/admin/page.tsx",
                                                lineNumber: 110,
                                                columnNumber: 15
...
_s(AdminDashboard, "nmx1p3e9peApOJjDQhKnycoLvjM=");
_c = AdminDashboard;
var _c;
...
//# sourceMappingURL=_0bb2c735._.js.map