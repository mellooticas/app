module.exports = [
"[project]/lib/supabase/admin-client.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const adminSupabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$esm$2f$wrapper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])(supabaseUrl, supabaseServiceRoleKey, {
    auth: {
...
"[project]/lib/supabase/queries/admin.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/admin-client.ts [app-ssr] (ecmascript)");
;
async function getAdminDashboardStats() {
    ...
    try {
        ...
        const alunosResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*', {
            count: 'exact',
            head: true
        ...
        const professoresResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*', {
            count: 'exact',
            head: true
        ...
        const aulasResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('aulas').select('*', {
            count: 'exact',
            head: true
        });
        ...
        const aulasHojeResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('aulas').select('*', {
            count: 'exact',
            head: true
...
async function getProfessores(filters) {
    try {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*', {
            count: 'exact'
        }).eq('tipo_usuario', 'professor');
        if (filters?.search) {
...
async function getProfessorById(userId) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*').eq('id', userId).eq('tipo_usuario', 'professor').single();
        if (error) throw error;
        return data;
    } catch (error) {
...
async function getAlunoById(userId) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('profiles').select('*').eq('id', userId).eq('tipo_usuario', 'aluno').single();
        if (error) throw error;
        return data;
    } catch (error) {
...
async function getAulasAgendadas(limit = 10) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSupabase"].from('aulas').select('*').order('data_programada', {
            ascending: true
        }).limit(limit);
        if (error) throw error;
        return data || [];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/queries/admin.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function AdminDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadStats() {
            ...
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAdminDashboardStats"])();
...
//# sourceMappingURL=_43ac9424._.js.map